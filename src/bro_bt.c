...
int bro_bt_connect_device (int * spam_sock, bdaddr_t mac_addr)
{
    ...
    */
	...
	//If somthing happen and the process exits without closing the socket, than socket remains occupied.
	//Keep socket, release and keep it again resolve this problem.
