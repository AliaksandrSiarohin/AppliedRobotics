/*
 *  kernel_cfg.c
 *  Fri Nov 06 18:56:10 2015
 *  SG Version 2.00
 *  sg.exe ./usb_client.oil -os=ECC2 -I../../../nxtOSEK/ecrobot/../toppers_osek/sg/impl_oil -template=../../../nxtOSEK/ecrobot/../toppers_osek/sg/lego_nxt.sgt
 */
