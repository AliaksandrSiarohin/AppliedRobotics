...
const TaskType PID_Controller = 0;
const TaskType BRO_Comm = 1;
const TaskType DisplayTask = 2;

extern void TASKNAME( PID_Controller )( void );
extern void TASKNAME( BRO_Comm )( void );
extern void TASKNAME( DisplayTask )( void );

static __STK_UNIT _stack_PID_Controller[__TCOUNT_STK_UNIT(512)];
...
const FP tinib_task[TNUM_TASK] = { TASKNAME( PID_Controller ), TASKNAME( BRO_Comm ), TASKNAME( DisplayTask ), };
const __STK_UNIT tinib_stk[TNUM_TASK] = { (__STK_UNIT)_stack_PID_Controller, (__STK_UNIT)_stack_BRO_Comm, (__STK_UNIT)_stack_DisplayTask, };
...
const AlarmType PID_alarm = 0;
const AlarmType BRO_Comm_alarm = 1;
const AlarmType lcd_update_alarm = 2;

DeclareTask(PID_Controller);
static void _activate_alarm_PID_alarm( void );
static void _activate_alarm_PID_alarm( void )
{ (void)ActivateTask( PID_Controller ); }
...
const FP alminib_cback[TNUM_ALARM] = { _activate_alarm_PID_alarm, _activate_alarm_BRO_Comm_alarm, _activate_alarm_lcd_update_alarm, };
...
const TickType alminib_cycle[TNUM_ALARM] = { 5, 2, 100, };
